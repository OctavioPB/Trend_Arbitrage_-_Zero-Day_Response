# AGENTS.md — Trend Arbitrage & Zero-Day Response System
...
| LLM classification | Anthropic Codex API (`Codex-sonnet-4-20250514`) | Categorize raw signals semantically |
...
LLM_MODEL=Codex-sonnet-4-20250514
LLM_MAX_TOKENS=512
```
